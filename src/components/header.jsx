...
export default function Header(){
    return (
        <header className="justify-center lg:justify-between w-full h-[100px] bg-accent flex items-center shrink-0 ">
            <Link to="/" className="lg:w-[200px] h-full flex justify-center items-center">
                <img src="/logo.jpeg" alt="" className="h-[70px] object-cover  rounded-full" />
            </Link>

            <div className="hidden lg:flex h-full w-[400px] justify-center items-center gap-3">
            ...
            <div className="hidden lg:flex w-70 h-12.5 justify-between items-center mr-8">
                ...
                <UserProfile className="flex justify-end"/>
            </div>
        </header>
    )
}